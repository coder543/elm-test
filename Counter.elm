...
view model =
    div [ style [ ( "padding", "2rem" ) ] ]
        [ Card.view
            ...
            [ Card.title [Options.center] [ Card.head [] [ text "Counter" ]
                            , Card.subhead [] [ text ("current count is " ++ toString model.count) ]
                            ]
            , Card.actions [ Options.center, Card.border ]
                [ Button.render Mdl
                    [ 1,0 ]
                    model.mdl
                    [ Options.onClick Decrease
                    , css "margin" "0px 8px 0px 0px"
                    ]
                    [ text "Decrease" ]
